...
function [rt_corr_data, rt_err_data, quantile_data] = each_trial_to_quantiles_with_contrast(data)
    empty_counter = 0;
    for ii = 1:25
        ...
        continue
            ...
            [quant_ctr, RT_corr, RT_err] = reaction_times_to_quantiles(subj);
            quantile_data(ind, :) = quant_ctr;
